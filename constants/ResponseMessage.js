class ResponseMessage {
  ...
  static get HEAD_coache_PHONE_REQUIRED() {
    return "Head coache phone number required";
  }
  static get HEAD_coache_PHONE_INVALID() {
    return "Head coache phone number invalid";
  }
